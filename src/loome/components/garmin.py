...
class GTR205xR(Component):
    def __init__(self, name: str, com_id: int | None = None):
        super().__init__(name)
        self.com_id = com_id
        if com_id == 2:
            self[14] >> self[35]
    ...
    headset_3_4_audio_out_right = Pin(8, "Headset 3/4 Audio Out Right")
    headset_2_audio_out_right = Pin(9, "Headset 2 Audio Out Right")
    headset_1_audio_out_right = Pin(10, "Headset 1 Audio Out Right")
    aux_3_audio_in_high = Pin(11, "Aux 3 Audio In High")
    aux_2_audio_in_high = Pin(12, "Aux 2 Audio In High")
    aux_1_audio_in_high = Pin(13, "Aux 1 Audio In High")
    disc_5 = Pin(14, "Disc 5")
    speaker_audio_out_high = Pin(15, "Speaker Audio Out High")
    com_audio_out_high = Pin(16, "Com Audio Out High")
    lighting_bus_high = Pin(17, "Lighting Bus High")
    mic_2_audio_in_high = Pin(18, "Mic 2 Audio In High")
    mic_1_audio_in_high = Pin(19, "Mic 1 Audio In High")
    ground_1 = Pin(20, "Ground 1")
    power_1 = Pin(21, "Power 1")
    config_module_data = Pin(22, "Config Module Data")
    config_module_ground = Pin(23, "Config Module Ground")
    mic_4_audio_in_low = Pin(27, "Mic 4 Audio In Low")
    mic_3_audio_in_low = Pin(28, "Mic 3 Audio In Low")
    headset_3_4_audio_out_low = Pin(29, "Headset 3/4 Audio Out Low")
    headset_2_audio_out_low = Pin(30, "Headset 2 Audio Out Low")
    headset_1_audio_out_low = Pin(31, "Headset 1 Audio Out Low")
    aux_3_audio_in_low = Pin(32, "Aux 3 Audio In Low")
    aux_2_audio_in_low = Pin(33, "Aux 2 Audio In Low")
    aux_1_audio_in_low = Pin(34, "Aux 1 Audio In Low")
    reserved_strap = Pin(35, "Reserved Strap")
    speaker_audio_out_low = Pin(36, "Speaker Audio Out Low")
    com_audio_out_low = Pin(37, "Com Audio Out Low")
    lighting_bus_low = Pin(38, "Lighting Bus Low")
    mic_2_audio_in_low = Pin(39, "Mic 2 Audio In Low")
    mic_1_audio_in_low = Pin(40, "Mic 1 Audio In Low")
    ground_2 = Pin(41, "Ground 2")
    power_2 = Pin(42, "Power 2")
    config_module_power = Pin(43, "Config Module Power")
    can = CanBus(45, 44)
    can_bus_term_b = Pin(47, "CAN Bus Term B")
    can_bus_term_a = Pin(48, "CAN Bus Term A")
    headset_3_4_audio_out_left = Pin(49, "Headset 3/4 Audio Out Left")
    headset_2_audio_out_left = Pin(50, "Headset 2 Audio Out Left")
    headset_1_audio_out_left = Pin(51, "Headset 1 Audio Out Left")
    aux_4_audio_in_high = Pin(52, "Aux 4 Audio In High")
    tx_interlock_out = Pin(53, "TX Interlock Out")
    external_com_key_out = Pin(54, "External Com Key Out")
    disc_4 = Pin(55, "Disc 4")
    disc_3 = Pin(56, "Disc 3")
    disc_2 = Pin(57, "Disc 2")
    disc_1 = Pin(58, "Disc 1")
    com_mic_2_key = Pin(59, "Com Mic 2 Key")
    com_mic_1_key = Pin(60, "Com Mic 1 Key")
    ground_3 = Pin(61, "Ground 3")
    power_3 = Pin(62, "Power 3")
