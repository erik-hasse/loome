...
class GDU116C(GDU116B):
    ...
    class J1015(Connector):
        ...
        mic_1_in = Pin(6, "Mic 1 Pilot Audio In (Audio Panel)/Com Mic Audio In")
        mic_1_low = Pin(23, "Mic 1 Low (Pilot, Audio Panel)/Com Mic Audio Low")
        ...
        external_com_mic_audio_out = Pin(13, "External Com Mic Audio Out (Audio Panel)/Com Audio Out")
        external_com_mic_audio_out_low = Pin(30, "External Com Mic Audio Out Low (Audio Panel)/Com Audio Out Low")
        speaker_out = Pin(14, "Speaker Out")
        nav_audio_out = Pin(15, "Nav Audio Out")
        speaker_out_low = Pin(31, "Speaker Out Low (Audio Panel)/Nav Audio Out Low")
