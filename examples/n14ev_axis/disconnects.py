from examples.n14ev_axis.lights import left_7_stars, left_pos_strobe, right_7_stars, right_pos_strobe
...
from examples.n14ev_axis.power import avionics_block_1, avionics_block_2, avionics_block_3, gnd
from examples.n14ev_axis.sensors import left_fuel, right_fuel
from examples.n14ev_axis.switches import landing_light_switch, pitot_heat_switch
...
right_wing_b_items = [
    ...
    (gsa28_roll.J281.can, mfd.J1012.can),
    # Fuel Sender
